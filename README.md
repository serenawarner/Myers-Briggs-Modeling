...
I used the types for each post to create 6 classifications: rational functions (binary), irrational functions (binary), dominant irrational functions (4 classes), dominant irrational functions (4 classes), dominant functions (8 classes), and auxiliary functions (8 classes). Here's how they're broken down for each type:
